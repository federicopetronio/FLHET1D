...
configFile = "config_alphaB_prm_study.ini"
...
if __name__ == '__main__':
    ...
    for j in range(nalpha):
        for i in range(j, nalpha):
            alpha_B1 = alpha_B1_arr[j]
            alpha_B2 = alpha_B2_arr[i]

            print(f"i={i:3d} aB2={alpha_B2:.2e} ;\tj={j:3d} aB1={alpha_B1:.2e} ;\tRunning...", end='\r')
